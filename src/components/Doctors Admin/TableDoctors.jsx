            ...
            <div className="modal-box w-[90%] max-w-2xl">
              ...
              <form action="" className="flex flex-wrap gap-x-2 justify-center gap-y-3 py-2 p-modal">
                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  <label>Name</label>
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-name" placeholder="Enter name from here"/>
                </div>
                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  <label>Email</label>
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-email" placeholder="Enter email from here" />
                </div>
                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  <label>Phone Number</label>
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-PhoneNumber" placeholder="Enter phone number from here"/>
                </div>
                <div className="lg:w-[98%] sm:w-[98%] flex flex-col gap-1">
                  <label>Subject</label>
                  <select
                    className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm"
                    name="doc-subject"
                    id="">
                    <option value="">Choose subject from here</option>
                ...
                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  ...
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-loginCode" placeholder="Enter login code from here"/>
                </div>

                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  <label>Password</label>
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-password" placeholder="Enter password from here"/>
                </div>

                <div className="lg:w-[32%] sm:w-[48%] flex flex-col gap-1">
                  <label>Confirm Password</label>
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="doc-confirmPassword" placeholder="Enter confirm password from here"/>
                </div>
              </form>
              <div className="mt-4">
