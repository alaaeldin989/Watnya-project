      ...
      <div className=" w-full">
        <div className=" border-b w-full">
          <div className="px-6 py-3 flex justify-between items-center">
            ...
            <div onClick={() => document.getElementById("my_modal_2").showModal()} className="bg-[#E9E9EE] text-[#666666] w-9 h-9 cursor-pointer hover:bg-[#303292b9] duration-300 hover:text-white flex items-center justify-center rounded-[8px]">
            ...
            <div className="modal-box w-[90%] max-w-2xl">
              ...
              <form action="" className="flex flex-wrap gap-x-2 justify-center gap-y-3 py-2 p-modal">
                <div className="lg:w-[48%] sm:w-[48%] flex flex-col gap-1">
                  ...
                  <input className="rounded-[8px] border text-[#666666] py-1.5 px-1.5 text-[14px] DIN-sm" type="text" name="Code" placeholder="Enter academic year here"/>
                </div>
                <div className="lg:w-[48%] sm:w-[48%] flex flex-col gap-1">
                ...
                <div className="w-[100%] flex gap-16 items-center">
                  ...
                  <input type="radio" defaultChecked className="checkbox checkbox-primary" name="option" value="Yes" />
                  <label>Yes</label>
                    </div>
                    <div className="flex gap-2">
                  <input type="radio" className="checkbox checkbox-primary" name="option" value="No" />
                  <label>No</label>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4">
                <form method="dialog" className="w-full flex justify-center gap-4 shadow-test py-4 px-4">
                  <button className=" bg-[#303192] text-[19px] h-[45px] DIN-sm rounded-[8px] text-white w-[35%]">Save</button>
